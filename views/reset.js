...
function showSuccessAlert() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = '/reset'; // Redireciona para a rota /reset
        }
    });
}
...
// Função para exibir o alerta de erro de reset
function showErrorResetAlert() {
    Swal.fire({
        icon: 'error',
        iconColor: '#dc3545',
        title: 'Erro',
        text: 'Não é possível resetar keys de outros vendedores',
        background: '#343a40',
        color: '#ffffff',
        confirmButtonColor: '#ff3333'  // Vermelho mais vivo para erro
    }).then((result) => {
